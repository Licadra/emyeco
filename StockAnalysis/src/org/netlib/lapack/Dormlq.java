...
public final class Dormlq {
    ...
    public static void dormlq(String side, String trans, int m, int n, int k, double[] a, int _a_offset, int lda,
        ...
        if (nb < nbmin || nb >= k) {
            ...
            for (int p = ((i2 - i1) + i3) / i3; p > 0; p--) {
                ...
                // Apply H or H**T
                Dlarfb.dlarfb(side, transt, "Forward", "Rowwise", mi, ni, ib, a, i - 1 + (i - 1) * lda + _a_offset, lda,
