...
public final class Dlaqr4 {
	public static void dlaqr4(boolean flag, boolean flag1, int i, int j, int k,
		...
		label0: {
			...
			intw.val = 0;
			l11 = Ilaenv.ilaenv(13, "DLAQR4", s, i, j, k, i3);
			l11 = Math.max(2, l11);
			l11 = Util.min((k - j) + 1, (i - 1) / 3, l11);
			j11 = l11;
			k10 = Ilaenv.ilaenv(15, "DLAQR4", s, i, j, k, i3);
			k10 = Util.min(k10, (i + 6) / 9, k - j);
			k10 = Math.max(2, k10 - k10 % 2);
			Dlaqr2.dlaqr2(flag, flag1, i, j, k, l11 + 1, ad, l, i1, l1, i2,
			...
			l9 = Ilaenv.ilaenv(12, "DLAQR4", s, i, j, k, i3);
			l9 = Math.max(11, l9);
			k9 = Ilaenv.ilaenv(14, "DLAQR4", s, i, j, k, i3);
			k9 = Math.max(0, k9);
			i5 = Ilaenv.ilaenv(16, "DLAQR4", s, i, j, k, i3);
			i5 = Math.max(0, i5);
			i5 = Math.min(2, i5);
			...
			for (int i12 = (j4 - 1) + 1; i12 > 0; i12--) {
				...
				int l7 = j11 + 2;
				int l10 = (i - j11 - l7) + 1;
				Dlaqr2.dlaqr2(flag, flag1, i, k6, j5, j11, ad, l, i1, l1, i2,
