...
public final class Dgerq2
{
    public static void dgerq2(int i, int j, double ad[], int k, int l, double ad1[], int i1, double ad2[], 
            int j1, intW intw)
    {
        int k1 = 0;
        int l1 = 0;
        ...
        {
            dlarfg_adapter((j - l1) + k1, ad, (((i - l1) + k1) - 1) + (((j - l1) + k1) - 1) * l + k, ad, (((i - l1) + k1) - 1) + k, l, ad1, (k1 - 1) + i1);
            double d1 = ad[(((i - l1) + k1) - 1) + (((j - l1) + k1) - 1) * l + k];
            ad[(((i - l1) + k1) - 1) + (((j - l1) + k1) - 1) * l + k] = 1.0D;
            Dlarf.dlarf("Right", ((i - l1) + k1) - 1, (j - l1) + k1, ad, (((i - l1) + k1) - 1) + k, l, ad1[(k1 - 1) + i1], ad, k, l, ad2, j1);
