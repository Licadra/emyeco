...
public final class Dlaqr3 {
	public static void dlaqr3(boolean flag, boolean flag1, int i, int j, int k,
		...
		if (i6 <= 2) {
			...
			Dlaqr4.dlaqr4(true, true, i6, 1, i6, ad5, l3, i4, ad2, k2, ad3, l2,
					1, i6, ad4, i3, j3, ad7, i5, -1, intw5);
			int j9 = (int) ad7[(1 - 1) + i5];
			k9 = Math.max(i6 + Math.max(l8, i9), j9);
		}
		if (j5 == -1) {
			ad7[(1 - 1) + i5] = k9;
			return;
		...
		l9 = Ilaenv.ilaenv(12, "DLAQR3", "SV", i6, 1, i6, j5);
		if (i6 > l9)
			Dlaqr4.dlaqr4(true, true, i6, 1, i6, ad5, l3, i4, ad2, (j8 - 1)
					+ k2, ad3, (j8 - 1) + l2, 1, i6, ad4, i3, j3, ad7, i5, j5,
					intw5);
		else
			Dlahqr.dlahqr(true, true, i6, 1, i6, ad5, l3, i4, ad2, (j8 - 1)
					+ k2, ad3, (j8 - 1) + l2, 1, i6, ad4, i3, j3, intw5);
		l5 = 1;
		for (int i10 = (i6 - 3 - 1) + 1; i10 > 0; i10--) {
		...
		while (intw3.val > intw.val) {
			...
			if (intw.val == 1)
				...
				flag12 = ad5[(intw.val - 1) + (intw.val - 1 - 1) * i4 + l3] != 0.0D;
			if (flag12 ^ true) {
		...
		if ((intw.val < i6) || (d7 == 0.0D)) {
			...
			if (flag)
				...
				k8 = j;
			int l7 = k8;
			for (int j10 = ((j8 - 1 - k8) + j4) / j4; j10 > 0; j10--) {
			...
			if (flag) {
				int k6 = k + 1;
				for (int k10 = ((i - (k + 1)) + k3) / k3; k10 > 0; k10--) {
			...
			if (flag1) {
				int i8 = k1;
				for (int l10 = ((l1 - k1) + j4) / j4; l10 > 0; l10--) {
